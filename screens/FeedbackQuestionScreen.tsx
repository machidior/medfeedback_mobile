...
const FeedbackQuestionScreen = ({ navigation, route }: FeedbackQuestionScreenProps) => {
  ...
  const fetchQuestionsForDepartment = async (departmentId: number): Promise<Question[]> => {
    try {
      ...
      const endpoints = [
        {
          url: 'http://192.168.196.214:8089/api/departments/department/questions',
        ...
        {
          url: `http://192.168.196.214:8089/api/departments/${departmentId}/questions`,
          params: {}
        },
        {
          url: `http://192.168.196.214:8089/api/questions/department/${departmentId}`,
          params: {}
        }
      ];
